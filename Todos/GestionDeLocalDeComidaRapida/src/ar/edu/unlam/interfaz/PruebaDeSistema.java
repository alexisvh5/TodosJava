...
public class PruebaDeSistema {
	...
	/****
	 * Se debe modificar el método main cumpliendo las siguientes condiciones:
	 * 1. Se debe solicitar el ingreso de las variables máximo y minimo hasta que se cumpla la condición que el máximo sea mayor al mínimo.
	 * 2. Se debe mostrar el menú principal hasta que el usuario decida finalizar (salir).
	 * 3. En SELECCIONAR_PRODUCTO, se debe repetir la acción hasta que la condición productosIngresados sea true.
	 * 
	 * @param args
	 */
	...
	private static void mostrarMenuPrincipal() {
		...
		String menu = "\t1-" + MenuPrincipal.SELECCIONAR_PRODUCTO + ". Agrega el producto solicitado por el usuario"
				+ "\n\t2-" + MenuPrincipal.GENERAR_PEDIDO + ". Genera un pedido con los detalles de los productos y del cliente"
				+ "\n\t3-" + MenuPrincipal.COBRAR_PEDIDO + ". Realiza el cobro de pedido" + "\n\t4-"
				+ MenuPrincipal.SALIR + ". Finaliza el programa";
